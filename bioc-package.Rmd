...
Again, it is acceptable to keep that part of the template as a placeholder and
reminder that as our new package is matures, we should use this section to
briefly demonstrate how to use the package.
