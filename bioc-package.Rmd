...
As this demonstration package may never be actually included in the Bioconductor
repository, we choose to replace the `BugReports` report field with the GitHub
Issues page for the repository instead.
